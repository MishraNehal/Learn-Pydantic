...
class Patient(BaseModel):  # Defining a Pydantic model (data schema)
    ...
    gender: str  # Code execution or logic here
...
patient_dict = {'name': 'nitish', 'gender': 'male', 'age': 35, 'address': address1}  # Assigning a value or defining a field

patient1 = Patient(**patient_dict)  # Assigning a value or defining a field

temp = patient1.model_dump()  # Assigning a value or defining a field
...
# Better organization of related data (e.g., vitals, address, insurance)  # Code execution or logic here

# Reusability: Use Vitals in multiple models (e.g., Patient, MedicalRecord)  # Code execution or logic here

# Readability: Easier for developers and API consumers to understand  # Code execution or logic here

# Validation: Nested models are validated automatically—no extra work needed  # Code execution or logic here